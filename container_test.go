...
func _TestButtonMouse(pressedPos image.Point, releasedPos image.Point) *MockButton {
	flex, button := testLayout()
...
func _TestMouseMove(mousePoint image.Point) *MockButton {
	flex, button := testLayout()
